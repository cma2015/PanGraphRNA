...
if ($reads_start_arg && $reads_start_arg  < 0){
	print "ERROR:The reads start position should great than 0.\n\n";
	exit;
}
if ($reads_end_arg && $reads_end_arg  < 0){
	print "ERROR:The reads end position should great than 0.\n\n";
	exit;
}
if ($reads_start_arg && $reads_end_arg && $reads_end_arg < $reads_start_arg){
	print "ERROR:The reads start position should great than end position.\n\n";
	exit;
}
